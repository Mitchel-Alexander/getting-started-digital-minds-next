  ...
  return (
    ...
    >
      ...
      <g transform="translate(960, 110)">
        ...
        <Ring r={115} opacity={0.75}  delay={0.20} duration={1.1} />
        <Ring r={190} opacity={0.563} delay={0.60} duration={1.6} />
        <Ring r={280} opacity={0.422} delay={0.80} duration={2.2} strokeWidth={0.5} />
        <Ring r={385} opacity={0.316} delay={1.00} duration={2.8} strokeWidth={0.5} />
      </g>

      {/* Secondary node — smaller, lower-left */}
      <g transform="translate(280, 268)">
        <Dot r={1.5} opacity={1}     delay={0.20} />
        <Ring r={32}  opacity={0.75}  delay={0.40} duration={0.4} />
        <Ring r={72}  opacity={0.563} delay={0.60} duration={0.8} />
        <Ring r={125} opacity={0.422} delay={0.80} duration={1.3} strokeWidth={0.5} />
      </g>

      {/* Tertiary node — faint, far-right */}
      <g transform="translate(1140, 285)">
        <Dot r={1}   opacity={1}     delay={0.40} />
        <Ring r={22} opacity={0.75}  delay={0.60} duration={0.3} strokeWidth={0.5} />
        <Ring r={55} opacity={0.563} delay={0.80} duration={0.6} strokeWidth={0.5} />
      </g>
    </svg>
  );
}

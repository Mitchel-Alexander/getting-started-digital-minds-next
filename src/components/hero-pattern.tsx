  ...
  return (
    ...
    >
      ...
      <g transform="translate(280, 268)">
        ...
        <Ring r={32}  opacity={0.14} delay={0.40} duration={0.4} />
        <Ring r={72}  opacity={0.09} delay={0.60} duration={0.8} />
        <Ring r={125} opacity={0.05} delay={0.80} duration={1.3} strokeWidth={0.5} />
      </g>

      {/* Tertiary node — faint, far-right */}
      <g transform="translate(1140, 285)">
        <Dot r={1}   opacity={0.30} delay={0.40} />
        <Ring r={22} opacity={0.09} delay={0.60} duration={0.3} strokeWidth={0.5} />
        <Ring r={55} opacity={0.05} delay={0.80} duration={0.6} strokeWidth={0.5} />
      </g>
    </svg>
  );
}

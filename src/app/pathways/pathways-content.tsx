...
export function PathwaysContent() {
  return (
    <>
      <PageHeader
        title="Pathways"
        description="Digital minds is a young, interdisciplinary field. There is no single route in. This page will help you find yours, whatever your background and career stage."
      />
